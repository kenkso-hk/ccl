    ...
    <>
      ...
      <div className='intro-y items-center mt-4'>
        <h1 className='text-lg text-white mr-auto'>
          <b>NEW CHILD CARE CENTER PROVIDER COMMERCIAL PRESCHOOL APPLICATION</b>
        </h1>
              ...
              <>
                <div className='items-center p-5 border-slate-200/60 dark:border-darkmode-400'>
                  <h2 className='font-medium text-base mr-auto mb-3'>
                    ...
                    I understand that I may only care for children ages 2-5 years. If I care for children younger than 2 years 
                    or older than 5 years a Child Care Center license will be required.
                </div>
              </>
            )}
          </PreviewComponent>
            ...
            {({ toggle }) => (
              <>
                ...
                <p className='ml-5 mr-10 mt-2'>
                  ...
                  Department of Health and Human Services, had a substantiated finding from
